...
Answer:
Based on the graph, the relationship is linear. 
...
ggplot(birds, aes(male_mass, egg_mass)) + 
  ...
  annotate("text", x = 5, y = 76,
           label = "Parrots") +
    annotate("point", x = 5, y = 90,
           color = "red") +
    annotate("rect", xmin = 3, xmax = 8.5,
                   ymin = 60, ymax = 100,
...
ggplot(birds, aes(male_mass, egg_mass)) + 
  ...
  scale_y_log10() +
  geom_smooth(method = "lm", color = "black", se = FALSE, linetype = "dashed", size = 0.5) +
  annotate("point", x = 218.7, y = 87, col = "red") +
  annotate("text", x = 218.7, y = 103, label = "Red-Tailed Tropicbird", size = 3)
...
ggplot(birds, aes(male_mass, egg_mass)) + 
  ggtitle(label="Bird Egg Mass vs. Male Mass") +
  geom_point(alpha = 0.15) +
  scale_x_log10() +
  scale_y_log10() +
  geom_point(data = penguins, color = "red") +
  geom_smooth(method = "lm", color = "black", se = FALSE, linetype = "dashed", size = 0.5) +
  annotate("point", x = 218.7, y = 87, col = "blue") +
  annotate("text", x = 218.7, y = 103, label = "Red-Tailed Tropicbird", size = 3) +
  annotate("point", x = 5, y = 90,
     color = "red") +
  annotate("rect", xmin = 3, xmax = 8.5,
