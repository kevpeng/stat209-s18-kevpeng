...
**Answer**: 34.5. This means that 30% of cereals have a healthiness score of 34.5 or less, and 70% of cereals have a healthiness score above 34.5.
...
**Answer**: Kelloggs has the highest single rating, but overall, Nabisco's cereals' health ratings are healthier.
...
**Answer**: Top shelf - Higher box of sugar and slightly higher box for health.
...
**Answer**: The scores tend to increase as the number of reviews increased.
...
**Answer**: 30.00. This means that 80% of teas cost less than or equal to 30 cents a cup and 20% of teas cost more than 30 cents a cup.
...
**Answer**: The number of reviews tend to be lower for the expensive teas compared to the cheap teas.
...
**Answer**: It was interesting seeing matcha's price mean lower than all the other teas. This can be attributed to the number of teas in this category being very low.
