...
**Answer**: The mean cost of a diamond is negative without any carats because that means you aren't purchasing any diamond.
...
**Answer**: If there is a carat involved, the price of diamond will raise with a true mean of 7729 - 7784
...
**Answer**: 5763.67 + 60 * (-29.65) = 3984.67

Describe in words the estimate of the slope in terms of the dataset.

**Answer**: For each unit of depth, expect the price of the diamond to drop -29.65 units of price.
...
**Answer**: The intercept was all positive, which means if there is a diamond, it will have a price. 
The slops was all negative, which means that adding depth to a diamond decreases their price.
...
**Answer**: 4045.3 + 50 * (- 102.2) + 2 * (7765.1) = 14465.5

Are both of the slopes in the model statistically significant? What are
their signs?

**Answer**: Yes. The depth is negative and the carat is positive. 
...
**Answer**: For each unit of depth, expect a decrease of -102.2 in price (intercept), and for each unit of carat, expect an increase in price.
...
**Answer**: I would expect the second diamond to 
be 7765.1 units of price more than diamond one.


diamond1: height = 1, carat = 2
> 4045.3 + 1 * (- 102.2) + 2 * (7765.1)
[1] 19473.3
diamond2:height = 1, carat = 1
> 4045.3 + 1 * (- 102.2) + 1 * (7765.1)
[1] 11708.2
difference in price
> 19473.3 - 11708.2
[1] 7765.1
