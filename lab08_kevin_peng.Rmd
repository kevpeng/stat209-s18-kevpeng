...
ggplot(mpg, aes(displ, hwy)) +
  geom_point(color = "green", size = 2) +
  geom_point(aes(x = displ, y = cty),color = "blue", size = 2)
```
...
ggplot(mpg, aes(displ, hwy)) +
  geom_point(color = "green", size = 2) +
  geom_point(aes(x = displ, y = cty),color = "red", size = 2)
...
ggplot(mpg, aes(displ, hwy)) +
  ...
  geom_point(aes(x = displ, y = cty),color = "red", size = 2) +
  ylab("Miles Per Gallon") +
  xlab("Size of Engine in Liters") +
  ggtitle("Miles per Gallons vs. Size of Engines")
